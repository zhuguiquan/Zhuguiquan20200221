 ...
 * function:
 */
public class PzssAdapter extends RecyclerView.Adapter<PzssAdapter.RxxpViewHolder> {


    private List<ShouyeBean.ResultBean.PzshBean.CommodityListBeanX> mRxxpscommodityList;

    public PzssAdapter(List<ShouyeBean.ResultBean.PzshBean.CommodityListBeanX> pzshsCommodityList) {

        mRxxpscommodityList = pzshsCommodityList;
    }
    ...
    public void onBindViewHolder(@NonNull RxxpViewHolder holder, int position) {
        ShouyeBean.ResultBean.PzshBean.CommodityListBeanX commodityListBean = mRxxpscommodityList.get(position);
